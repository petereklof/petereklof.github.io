              ...
              <div className="col">
                ...
                <ul className="nav nav-tabs nav-overflow header-tabs">
                  <li className="nav-item">
                    <a href="http://hej.se" className="nav-link active">Dashboard</a>
                  </li>
                  <li className="nav-item">
                    <a href="http://hej.se" className="nav-link">Profile</a>
                  </li>
                  <li className="nav-item">
                    <a href="http://hej.se" className="nav-link">Nav 3</a>
                  </li>
                  <li className="nav-item">
                    <a href="http://hej.se" className="nav-link">Nav 4</a>
                  </li>
                  <li className="nav-item">
                    <a href="http://hej.se" className="nav-link">Nav 5</a>
                  </li>
                </ul>
              ...
              <div className="table-responsive mb-0" data-toggle="lists" data-lists-values='["goal-project", "goal-status", "goal-progress", "goal-date"]'>
                <table className="table table-sm table-nowrap card-table">
                  <thead>
                    <tr>
                      <th>
                        <a href="http://hej.se" className="text-muted sort" data-sort="goal-project">Goal</a>
                      </th>
                      <th>
                        <a href="http://hej.se" className="text-muted sort" data-sort="goal-status">Status</a>
                      </th>
                      <th>
                        <a href="http://hej.se" className="text-muted sort" data-sort="goal-progress">Progress</a>
                      </th>
                      <th>
                        <a href="http://hej.se" className="text-muted sort" data-sort="goal-date">Due date</a>
                      </th>
