...
module.exports = (function (e) {
  ...
  function (e, t, r) {
    ...
    const i = r(1),
      ...
      s = r(3),
      a = ({
        accept: e = ".csv, text/csv",
        cssClass: t = "csv-reader-input",
        cssInputClass: r = "csv-input",
        cssLabelClass: n = "csv-label",
        fileEncoding: a = "UTF-8",
        inputId: o = "react-csv-reader-input",
        inputStyle: u = {},
        label: h,
        onError: f,
        onFileLoaded: l,
        ...
        i.createElement(
          "div",
          { className: t },
          h && i.createElement("label", { className: n, htmlFor: o }, h),
          i.createElement("input", {
            ...
            onChange: (e) =>
              ((e) => {
                ...
                if (r.length > 0) {
                  const e = { name: r[0].name, size: r[0].size, type: r[0].type };
                  (t.onload = (r) => {
                    var i;
                    const n = s.parse(t.result, Object.assign(d, { error: f, encoding: a }));
                    l(null !== (i = null === n ? void 0 : n.data) && void 0 !== i ? i : [], e);
                  }),
                    t.readAsText(r[0], a);
                }
              })(e),
    ...
    (a.propTypes = {
      accept: n.string,
      cssClass: n.string,
      cssInputClass: n.string,
      cssLabelClass: n.string,
      fileEncoding: n.string,
      inputId: n.string,
      inputStyle: n.object,
      label: n.oneOfType([n.string, n.element]),
      onError: n.func,
      onFileLoaded: n.func.isRequired,
      parserOptions: n.object,
      disabled: n.bool,
    }),
      (t.default = a);
  },
        ...
        "function" ==
          typeof (i = function e() {
            var t = "undefined" !== typeof self ? self : "undefined" !== typeof window ? window : void 0 !== t ? t : {},
              ...
              a = {
                parse: function (r, i) {
                  ...
                  if ((k(o) && ((i.dynamicTypingFunction = o), (o = {})), (i.dynamicTyping = o), (i.transform = !!k(i.transform) && i.transform), i.worker && a.WORKERS_SUPPORTED)) {
                    var u = (function () {
                      if (!a.WORKERS_SUPPORTED) return !1;
                      var r,
                        i,
                        o = ((r = t.URL || t.webkitURL || null), (i = e.toString()), a.BLOB_URL || (a.BLOB_URL = r.createObjectURL(new Blob(["(", i, ")();"], { type: "text/javascript" })))),
                        u = new t.Worker(o);
                  ...
                  return (
                    a.NODE_STREAM_INPUT,
                    "string" === typeof r ? (c = i.download ? new h(i) : new l(i)) : !0 === r.readable && k(r.read) && k(r.on) ? (c = new d(i)) : ((t.File && r instanceof File) || r instanceof Object) && (c = new f(i)),
                    c.stream(r)
                  );
                },
                unparse: function (e, t) {
                  ...
                  !(function () {
                    if ("object" === typeof t) {
                      ...
                      void 0 !== t.escapeChar && (u = t.escapeChar + o), "boolean" === typeof t.escapeFormulae && (l = t.escapeFormulae);
                    }
                  })();
                  var d = new RegExp(p(o), "g");
                  if (("string" === typeof e && (e = JSON.parse(e)), Array.isArray(e))) {
                    if (!e.length || Array.isArray(e[0])) return g(null, e, h);
                    if ("object" === typeof e[0]) return g(f || c(e[0]), e, h);
                  } else if ("object" === typeof e)
                    return (
                      "string" === typeof e.data && (e.data = JSON.parse(e.data)),
                      Array.isArray(e.data) &&
                      (e.fields || (e.fields = e.meta && e.meta.fields),
                        e.fields || (e.fields = Array.isArray(e.data[0]) ? e.fields : c(e.data[0])),
                  ...
                  function g(e, t, r) {
                    ...
                    var o = Array.isArray(e) && 0 < e.length,
                      u = !Array.isArray(t[0]);
                    if (o && i) {
                      for (var h = 0; h < e.length; h++) 0 < h && (a += n), (a += m(e[h], h));
                      0 < t.length && (a += s);
                    }
              ...
              o.fn.parse = function (e) {
                ...
                return (
                  this.each(function (e) {
                    ...
                    for (var n = 0; n < this.files.length; n++) i.push({ file: this.files[n], inputElem: this, instanceConfig: o.extend({}, r) });
                  }),
                  n(),
                  this
                );
                function n() {
                  if (0 !== i.length) {
                    ...
                    if (k(e.before)) {
                      ...
                      if ("object" === typeof h) {
                        if ("abort" === h.action) return (t = u.file), (r = u.inputElem), (n = h.reason), void (k(e.error) && e.error({ name: "AbortError" }, t, r, n));
              ...
              (this._handle = null),
                ...
                (this.parseChunk = function (e, r) {
                  ...
                  if (!this._handle.paused() && !this._handle.aborted()) {
                    ...
                    if (i) t.postMessage({ results: o, workerId: a.WORKER_ID, finished: h });
                    ...
                    return (
                      ...
                      ((this._completeResults.data = this._completeResults.data.concat(o.data)),
                        (this._completeResults.errors = this._completeResults.errors.concat(o.errors)),
                        (this._completeResults.meta = o.meta)),
                      this._completed || !h || !k(this._config.complete) || (o && o.meta.aborted) || (this._config.complete(this._completeResults, this._input), (this._completed = !0)),
                ...
                (this._sendError = function (e) {
                  k(this._config.error) ? this._config.error(e) : i && this._config.error && t.postMessage({ workerId: a.WORKER_ID, error: e, finished: !1 });
                });
            }
            function h(e) {
              var t;
                  ...
                  if (this._finished) this._chunkLoaded();
                    ...
                    if (
                      ((t = new XMLHttpRequest()),
                        ...
                        r || ((t.onload = b(this._chunkLoaded, this)), (t.onerror = b(this._chunkError, this))),
            ...
            function c(e) {
              ...
              if (k(e.step)) {
                ...
                e.step = function (t) {
                  if (((_ = t), w())) E();
                    ...
                    (f += t.data.length), e.preview && f > e.preview ? r.abort() : ((_.data = _.data[0]), v(_, h));
                  }
                };
              }
              function b(t) {
              ...
              function E() {
                if ((_ && i && (R("Delimiter", "UndetectableDelimiter", "Unable to auto-detect delimiting character; defaulted to '" + a.DefaultDelimiter + "'"), (i = !1)), e.skipEmptyLines))
                  for (var t = 0; t < _.data.length; t++) b(_.data[t]) && _.data.splice(t--, 1);
                return (
                  w() &&
                  (function () {
                    if (_)
                      if (Array.isArray(_.data[0])) {
                        for (var t = 0; w() && t < _.data.length; t++) _.data[t].forEach(r);
                        _.data.splice(0, 1);
                      } else _.data.forEach(r);
                    function r(t, r) {
                      k(e.transformHeader) && (t = e.transformHeader(t, r)), m.push(t);
                    }
                  })(),
                  (function () {
                    ...
                    function t(t, r) {
                      ...
                      for (i = 0; i < t.length; i++) {
                        var s = i,
                          a = t[i];
                        e.header && (s = i >= m.length ? "__parsed_extra" : m[i]), e.transform && (a = e.transform(a, s)), (a = C(s, a)), "__parsed_extra" === s ? ((n[s] = n[s] || []), n[s].push(a)) : (n[s] = a);
                      }
                      return (
                        e.header &&
                        (i > m.length
                          ? R("FieldMismatch", "TooManyFields", "Too many fields: expected " + m.length + " fields but parsed " + i, l + r)
                          : i < m.length && R("FieldMismatch", "TooFewFields", "Too few fields: expected " + m.length + " fields but parsed " + i, l + r)),
                        n
                      );
                    }
                    var r = 1;
                    return !_.data.length || Array.isArray(_.data[0]) ? ((_.data = _.data.map(t)), (r = _.data.length)) : (_.data = t(_.data, 0)), e.header && _.meta && (_.meta.fields = m), (l += r), _;
                  })()
                );
              }
              function w() {
              ...
              (this.parse = function (n, s, o) {
                ...
                if (
                  ...
                  k(e.delimiter) && ((e.delimiter = e.delimiter(n)), (_.meta.delimiter = e.delimiter));
                else {
                  var h = (function (t, r, i, n, s) {
                    ...
                    for (var l = 0; l < s.length; l++) {
                      var d = s[l],
                        ...
                        m = 0;
                      h = void 0;
                      for (var _ = new g({ comments: n, delimiter: d, newline: r, preview: 10 }).parse(t), v = 0; v < _.data.length; v++)
                        if (i && b(_.data[v])) m++;
                        else {
                          var y = _.data[v].length;
                          (p += y), void 0 !== h ? 0 < y && ((c += Math.abs(y - h)), (h = y)) : (h = y);
                        }
                      0 < _.data.length && (p /= _.data.length - m), (void 0 === u || c <= u) && (void 0 === f || f < p) && 1.99 < p && ((u = c), (o = d), (f = p));
                    }
                ...
                var f = y(e);
                return e.preview && e.header && f.preview++, (t = n), (r = new g(f)), (_ = r.parse(t, s, o)), E(), d ? { meta: { paused: !0 } } : _ || { meta: { paused: !1 } };
              }),
                ...
                (this.resume = function () {
                  h.streamer._halted ? ((d = !1), h.streamer.parseChunk(t, !0)) : setTimeout(h.resume, 3);
                }),
                (this.aborted = function () {
                  return c;
                }),
                (this.abort = function () {
                  (c = !0), r.abort(), (_.meta.aborted = !0), k(e.complete) && e.complete(_), (t = "");
                });
            }
            function p(e) {
              return e.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
              ...
              (this.parse = function (e, a, d) {
                ...
                if (u || (!1 !== u && -1 === e.indexOf(t))) {
                  for (var C = e.split(i), R = 0; R < C.length; R++) {
                    if (((E = C[R]), (f += E.length), R !== C.length - 1)) f += i.length;
                    else if (d) return z();
                    if (!n || E.substring(0, _) !== n) {
                      if (v) {
                        if (((y = []), L(E.split(r)), q(), l)) return z();
                      } else L(E.split(r));
                ...
                for (var O = e.indexOf(r, f), S = e.indexOf(i, f), x = new RegExp(p(h) + p(t), "g"), T = e.indexOf(t, f); ;)
                  if (e[f] !== t)
                    if (n && 0 === E.length && e.substring(f, f + _) === n) {
                      if (-1 === S) return z();
                      (f = S + m), (S = e.indexOf(i, f)), (O = e.indexOf(r, f));
                    } else {
                      if (-1 !== O && (O < S || -1 === S)) {
                        if (!(O < T)) {
                          E.push(e.substring(f, O)), (f = O + g), (O = e.indexOf(r, f));
                          continue;
                        }
                        var I = P(O, T, S);
                        if (I && void 0 !== I.nextDelim) {
                          (O = I.nextDelim), (T = I.quoteSearch), E.push(e.substring(f, O)), (f = O + g), (O = e.indexOf(r, f));
                          continue;
                        }
                      }
                      if (-1 === S) break;
                      if ((E.push(e.substring(f, S)), M(S + m), v && (q(), l))) return z();
                      if (o && y.length >= o) return z(!0);
                    }
                  else
                    for (T = f, f++; ;) {
                      if (-1 === (T = e.indexOf(t, T + 1))) return d || b.push({ type: "Quotes", code: "MissingQuotes", message: "Quoted field unterminated", row: y.length, index: f }), j();
                      if (T === c - 1) return j(e.substring(f, T).replace(x, t));
                      if (t !== h || e[T + 1] !== h) {
                        if (t === h || 0 === T || e[T - 1] !== h) {
                          -1 !== O && O < T + 1 && (O = e.indexOf(r, T + 1)), -1 !== S && S < T + 1 && (S = e.indexOf(i, T + 1));
                          var D = F(-1 === S ? O : Math.min(O, S));
                          if (e[T + 1 + D] === r) {
                            E.push(e.substring(f, T).replace(x, t)), e[(f = T + 1 + D + g)] !== t && (T = e.indexOf(t, f)), (O = e.indexOf(r, f)), (S = e.indexOf(i, f));
                            break;
                          }
                          var A = F(S);
                          if (e.substring(T + 1 + A, T + 1 + A + m) === i) {
                            if ((E.push(e.substring(f, T).replace(x, t)), M(T + 1 + A + m), (O = e.indexOf(r, f)), (T = e.indexOf(t, f)), v && (q(), l))) return z();
                            if (o && y.length >= o) return z(!0);
                            break;
                          }
                          b.push({ type: "Quotes", code: "InvalidQuotes", message: "Trailing quote on quoted field is malformed", row: y.length, index: f }), T++;
                        }
                      } else T++;
                    }
                return j();
                ...
                function j(t) {
                  return d || (void 0 === t && (t = e.substring(f)), E.push(t), (f = c), L(E), v && q()), z();
                }
                function M(t) {
                  (f = t), L(E), (E = []), (S = e.indexOf(i, f));
                }
                function z(e) {
                  return { data: y, errors: b, meta: { delimiter: r, linebreak: i, aborted: l, truncated: !!e, cursor: w + (a || 0) } };
                }
                function q() {
                  s(z()), (y = []), (b = []);
                }
                function P(i, n, s) {
                  ...
                  if (n < i && i < o && (o < s || -1 === s)) {
                    var u = e.indexOf(r, o);
                    if (-1 === u) return a;
                    o < u && (o = e.indexOf(t, o + 1)), (a = P(u, o, s));
            ...
            function m(e) {
              ...
              if (t.error) r.userError(t.error, t.file);
                ...
                if (k(r.userStep)) {
                  for (var a = 0; a < t.results.data.length && (r.userStep({ data: t.results.data[a], errors: t.results.errors, meta: t.results.meta }, s), !i); a++);
                  delete t.results;
                } else k(r.userChunk) && (r.userChunk(t.results, s, t.file), delete t.results);
              }
            ...
            return (
              ...
              (t.onmessage = function (e) {
                var r = e.data;
                if ((void 0 === a.WORKER_ID && r && (a.WORKER_ID = r.workerId), "string" === typeof r.input)) t.postMessage({ workerId: a.WORKER_ID, results: a.parse(r.input, r.config), finished: !0 });
